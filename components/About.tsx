...
export default function About({ pageInfo }: Props) {
    ...
    return (
        ...
        >
            <h3 className="absolute ngukuk:top-[60px] top-[70px] md:top-20 md:-mt-16 uppercase tracking-[20px] text-gray-500 ngukuk:text-[16px] text-2xl md:text-4xl">
                About
            </h3>
            ...
            <motion.img
                ...
                className="-mb-10 md:-mb-0 flex-shrink-0 ngukuk:w-16 ngukuk:h-16 w-32 h-32 md:w-48 md:h-48 xl:w-[320px] xl:h-[400px] rounded-full object-cover md:rounded-lg"
            />

            <div className="space-y-5 md:space-y-10 md:px-10">
                <h4 className="ngukuk:text-[20px] text-xl md:text-4xl font-semibold">
                    My <span className="underline decoration-[#F7AB0A]">little</span> background
                </h4>
                <p className="ngukuk:text-[8px] text-sm md:text-base">
